...
function Home() {
    ...
    const content_c = [
        <span>
            -[c1]<LinkComponent text="競技プログラミングサークルRiPPro" url="https://rippro.github.io/" />
        </span>,
        <span>
    ...
    <span>
      <LinkComponent text="Boid Work" url="https://super-saurus.github.io/super-saurus-boid-demo/" />
    </span>}
